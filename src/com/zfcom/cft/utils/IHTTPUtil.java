...
public class IHTTPUtil {
	...
	public static JSONObject post(String url, Map<String, Object> parameters) {
		return post(url, parameters, 0);
	}

	public static JSONObject post(String url, Map<String, Object> parameters, int retryCount) {
	...
	public static JSONObject post(String url, Map<String, Object> headers, String params, int retryCount) {
		try {
			byte[] postDataBytes = params.getBytes("UTF-8");
			return post(url, headers, postDataBytes, retryCount);
	...
	public static JSONObject post(String url, Map<String, Object> headers, byte[] postDataBytes, int retryCount) {
		...
		do {
			...
			try {
				...
				e.printStackTrace();
				result = obtainExceptionMessage(e);
			}
	...
	public static void postAsync(String url, Map<String, Object> parameters, ResponseCallBack handler) {
		postAsync(url, parameters, 0, handler);
	}

	public static void postAsync(String url, Map<String, Object> parameters, int retryCount, ResponseCallBack handler) {
	...
	public static void postAsync(final String url, final Map<String, Object> headers, final String jsonString, final int retryCount,
	...
	public static final String KEY_RAW_RESPONSE = "__raw_response__";
	public static final String KEY_CONNECTION_OBJ = "__connection_obj__";
	public static final String KEY_EXCEPTION_OBJ = "__exception_obj__";
	...
	public static JSONObject transferResponseToJsonObject(String responseString, HttpURLConnection connnection) throws JSONException {
		...
		jsonObject.put(KEY_RAW_RESPONSE, raw);
		jsonObject.put(KEY_CONNECTION_OBJ, connnection);

		if ((raw.startsWith("{") && raw.endsWith("}")) || (raw.startsWith("[") && raw.endsWith("]"))) {
			jsonObject = (JSONObject) JSON.parse(raw);
		}

		return jsonObject;
	}
	
	public static JSONObject obtainExceptionMessage(Exception e) {
		JSONObject result = new JSONObject();
		try {
			result.put(KEY_EXCEPTION_OBJ, e);
